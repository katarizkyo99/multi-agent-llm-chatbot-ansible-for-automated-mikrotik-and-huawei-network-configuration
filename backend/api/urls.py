...
from .views import ChatView, get_chats, get_chat_messages, create_chat, delete_chat,get_riwayat_konfigurasi, add_riwayat_konfigurasi, save_message, execute_config, ping_device, get_network_devices
urlpatterns = [
